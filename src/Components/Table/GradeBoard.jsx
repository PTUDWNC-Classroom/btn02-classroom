...
export default function GradeBoard() {
  const { gradeStruct, classDetails, totalGradeCol, updateTotalGradeCol, rerender } = useContext(tabsContext)
  ...
  }, [classDetails, rerender, gradeStruct])
